  ...
  */
	...
	function handleLabelPosition(lblPositionFnc, highValue, barValue, thresholdPercentage) {
		...
		if (positionData.labelOffset) {
			...
			if (positionData.labelOffset.x) result.labelOffset.x = positionData.labelOffset.x;

			if (positionData.labelOffset.y) result.labelOffset.y = positionData.labelOffset.y;
		}
		if (positionData.textAnchor) result.textAnchor = positionData.textAnchor;
